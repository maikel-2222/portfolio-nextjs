...
export default function Contact() {
  return (
    <div className="divide-y divide-gray-500 dark:divide-gray-700">
      <div className="space-y-4 py-8 md:space-x-5 md:flex md:items-center md:justify-between">
        <div className="text-center md:text-left">
          <h1 className="text-4xl font-extrabold leading-10 text-gray-900 dark:text-gray-100 md:text-6xl md:leading-13">
            Contact
          </h1>
        ...
        <div className="md:w-1/2 overflow-hidden rounded-lg shadow-lg">
          <iframe
            ...
            loading="lazy"
            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAbXv2410OTLFdABW_VeZaMU4DdyWpxsDY&q=Boumaboulevard+573,Groningen"
            allowFullScreen
          ></iframe>
        </div>
      </div>
